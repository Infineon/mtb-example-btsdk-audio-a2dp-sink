...
1. Build and download the application to the WICED board.( If using CYW943012BTEVK-01, must reboot the board before downloading the application)
...
4. This app can also mute/unmute the streaming audio by pressing the CUSTOM button on the WICED board, except with 43012-related platform.
   For example, a2dp_sink with platform CYW920721B2EVK-02 can support mute/unmute button but with CYW9M2BASE-43012BT and CYW943012BTEVK-01 cannot.
