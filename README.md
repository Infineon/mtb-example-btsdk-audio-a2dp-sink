...
3. Audio source devices such as smartphones or the BTSDK watch app can discover the sink device, connect to it and start/stop streaming. This app can also mute/unmute the streaming audio by pressing the App button on the WICED board.
